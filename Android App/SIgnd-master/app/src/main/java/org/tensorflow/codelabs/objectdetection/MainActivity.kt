...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    lateinit var Text_Speech : String
        ...
        val resultToDisplay = results.map {
            ...
            tts = TextToSpeech(applicationContext, TextToSpeech.OnInitListener {
                if(it==TextToSpeech.SUCCESS){
                    ...
                    tts.speak(category.label,TextToSpeech.QUEUE_ADD,null)

                }
            })*/
        }

// Draw the detection result  the bitmap and show it.
    ...
    private fun speak(ttt:String) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.DONUT) {
            tts = TextToSpeech(applicationContext, TextToSpeech.OnInitListener {
                if(it==TextToSpeech.SUCCESS){
                    tts.language = Locale.US
                    tts.setSpeechRate(1.0f)
                    tts.speak(ttt,TextToSpeech.QUEUE_ADD,null)
